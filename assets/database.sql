...
-- --------------------------------------------------------
insert into loginn (username,password) values ('admin','123456');
insert into loginn (username,password) values ('john','abcd');
insert into loginn (username,password) values ('mike','0d107d09f5bbe40cade3de5c71e9e9b7');
-- --------------------------------------------------------
